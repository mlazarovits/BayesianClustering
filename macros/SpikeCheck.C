...
void SpikeCheck(){
	...
	TH2D* rhE_e4e1 = new TH2D("rhE_e4e1","rhE_e4e1",50,0,1e3,50,0,0.12);
	TH2D* swCross_Ecut = new TH2D("swCross_Ecut","swCross_Ecut",50,0,0.12,50,0,0.1);

	TH2D* swCross_rhTime = new TH2D("swCross_rhTime","swCross_rhTime",50,0.2,1.2,120,-60,60);
	TH2D* swCross_rhTime_reject = new TH2D("swCross_rhTime_reject","swCross_rhTime_reject",50,0.2,1.2,120,-60,60);
	TH2D* swCross_rhTime_accept = new TH2D("swCross_rhTime_accept","swCross_rhTime_accept",50,0.2,1.2,120,-60,60);

	TH2D* swCross_rhE_reject = new TH2D("swCross_rhE_reject","swCross_rhE_reject",50,0.2,1.2,120,-60,60);
	TH2D* swCross_rhE_accept = new TH2D("swCross_rhE_accept","swCross_rhE_accept",50,0.2,1.2,120,-60,60);
	...
	for(int i = 0; i < nevts; i++){
		...
		for(int r = 0; r < nrhs; r++){
			...
			swCross_rhTime->Fill(1 - base->ECALRecHit_swCross->at(r), base->ECALRecHit_time->at(r));
