...
int EventWeightCalc(string selection = ""){
	...
	vector<string> files;
	files.push_back("GJets_R17"+selection+"_v24_GJets_HT-40To100_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GJets_R17"+selection+"_v24_GJets_HT-100To200_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GJets_R17"+selection+"_v24_GJets_HT-200To400_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GJets_R17"+selection+"_v24_GJets_HT-400To600_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GJets_R17"+selection+"_v24_GJets_HT-600ToInf_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GMSB_R17"+selection+"_v24_GMSB_L-150TeV_Ctau-0_1cm_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GMSB_R17"+selection+"_v24_GMSB_L-150TeV_Ctau-200cm_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GMSB_R17"+selection+"_v24_GMSB_L-350TeV_Ctau-0_1cm_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GMSB_R17"+selection+"_v24_GMSB_L-350TeV_Ctau-1000cm_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("GMSB_R17"+selection+"_v24_GMSB_L-350TeV_Ctau-200cm_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT1000to1500_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT100to200_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT1500to2000_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT2000toInf_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT200to300_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT300to500_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT500to700_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT50to100_AODSIM_RunIIFall17DRPremix.root");
	files.push_back("QCD_R17"+selection+"_v24_QCD_HT700to1000_AODSIM_RunIIFall17DRPremix.root");
	ofstream ofile;
