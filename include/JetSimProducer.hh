...
class JetSimProducer{
	public:
		...
		void GetRecHits(vector<JetPoint>& rhs, int evt, const PointCollection& central_points = PointCollection());
		void GetRecHits(vector<Jet>& rhs, int evt, const PointCollection& central_points = PointCollection());
