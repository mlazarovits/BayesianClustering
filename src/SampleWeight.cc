...
void SampleWeight::Init(){
	...
	_sampleToWeights["GJets_HT-40To100"].SetLumiScale(1.);
	_sampleToWeights["GJets_HT-100To200"].SetLumiScale(1.);
	_sampleToWeights["GJets_HT-200To400"].SetLumiScale(1.);
	_sampleToWeights["GJets_HT-400To600"].SetLumiScale(1.);
	_sampleToWeights["GJets_HT-600ToInf"].SetLumiScale(1.);
	...
	_sampleToWeights["GJets_HT-40To100"].SetXsec(18620.0);
	_sampleToWeights["GJets_HT-100To200"].SetXsec(8625.0);
	_sampleToWeights["GJets_HT-200To400"].SetXsec(2196.0);
	_sampleToWeights["GJets_HT-400To600"].SetXsec(258.0);
	_sampleToWeights["GJets_HT-600ToInf"].SetXsec(85.18);
